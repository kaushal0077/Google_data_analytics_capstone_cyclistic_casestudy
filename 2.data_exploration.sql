...
from `adept-lodge-374014.bikeshare_cyclistic.complete_trip_data`
where
start_station_name is null                                       ----834545 null rows-----
...
from `adept-lodge-374014.bikeshare_cyclistic.complete_trip_data`
where
start_station_id is null                                         ----834677 nulls rows----
...
from `adept-lodge-374014.bikeshare_cyclistic.complete_trip_data`
where
end_station_id is null                                         ----891898 nulls rows----
...
from `adept-lodge-374014.bikeshare_cyclistic.complete_trip_data`
where
end_lat is null                                              ---- 5961 null rows ----
...
from `adept-lodge-374014.bikeshare_cyclistic.complete_trip_data`
where
end_lng is null                                             ----5961 null rows ----
